...
class Oregistration extends React.Component{
  ...
  handleChange=(e)=>{
    ...
    this.setState({errors,[nm]: val,uservalid: userflag, emailvalid: emailflag, pwdvalid: pwdflag, contactvalid: contactflag, adharvalid: adharflag}, ()=>{this.setState({formvalid: this.state.uservalid && this.state.emailvalid && this.state.pwdvalid && this.state.contactvalid && this.state.adharvalid} )})
  }
  submitData=(e)=>{
    e.preventDefault();
    const reqOptions={
    ...
    <div class="container-fluid my-3">
        <div class="row justify-content-around">
            <div class="col-md-7 bg-light shadow px-4 pt-4">
                <h4 class="display-4">
                <i class="fa fa-user-plus" aria-hidden="true"></i> Owner Sign Up</h4>
            ...
            <FormGroup row>
                ...
                <br/>
            <FormGroup row>
                <Label for="exampleAdharno">Enter Adhar Number : </Label>
                <Col sm={12}>
